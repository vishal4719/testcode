...
function TestManagement() {
    ...
    async function fetchData() {
      ...
      try {
        ...
        const [testsRes, questionsRes, olderTestsRes] = await Promise.all([
          axios.get(`${process.env.REACT_APP_API_URL}/api/tests/active`, config),
          axios.get(`${process.env.REACT_APP_API_URL}/api/questions`, config),
          axios.get(`${process.env.REACT_APP_API_URL}/api/tests/inactive-for-user`, config)
        ]);
  ...
  const handleCreateTest = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${process.env.REACT_APP_API_URL}/api/tests`, testData, config);
  ...
  const handleDeactivateTest = async (id) => {
    try {
      ...
      await axios.delete(`${process.env.REACT_APP_API_URL}/api/tests/${id}`, config);
  ...
  const handleLaunchTest = async (testId, testLink) => {
    try {
      ...
      await axios.post(
        `${process.env.REACT_APP_API_URL}/api/tests/${testId}/launch`,
        {},
        config
      );
      ...
      const testsRes = await axios.get(`${process.env.REACT_APP_API_URL}/api/tests/active`, config);
